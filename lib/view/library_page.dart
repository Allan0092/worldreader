      ...
      bottomNavigationBar: Container(
        ...
        child: Row(
          ...
          children: [
            Container(
                child: const Text(
                    style: TextStyle(color: Colors.white), "Explore")),
            Container(
              child:
                  const Text(style: TextStyle(color: Colors.white), "Library"),
            ),
            Container(
              child: const Text(style: TextStyle(color: Colors.white), "Store"),
            )
          ],
        ),
      ),
